...
- 1 个月内审核 **500+** 份模板文案
- 梳理出 **60+** 处常见错误，形成校对标准文档
- 该文档被用作岗位培训参考材料
- 培养了对质量标准和流程规范（SOP）的实操经验
...
- 方向兴趣：RLHF 偏好对齐 · 中文 NLP · 红队测试 · 数据质量迭代
...
| 文档 | 说明 |
|------|------|
| [偏好标注规范 v1.0](./docs/偏好标注规范_v1.0.md) | 4维度评分体系、决策规则、边缘案例协议 |
| [CoT思维链标注示例集](./docs/CoT思维链标注示例集.md) | 10个网络新词的完整4步推导 |
| [红队测试场景卡片](./docs/红队测试场景卡片.md) | 5个攻击场景的详细测试方案 |
| [技术博客](./docs/技术博客_从情感词典到RLHF.md) | 项目复盘：从情感分析到RLHF的思考 |
